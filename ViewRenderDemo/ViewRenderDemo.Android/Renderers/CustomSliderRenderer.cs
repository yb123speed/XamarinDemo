...
{
    public class CustomSliderRenderer : SliderRenderer, SeekBar.IOnSeekBarChangeListener
    {
        ...
        static readonly int MINVALUE = 100;
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Slider> e)
        {
            ...
            if (Control != null)
            {
                var thumbBitmap = BitmapFactory.DecodeResource(Context.Resources, Resource.Mipmap.thumb);
        ...
        private void OnProcessChanged(SeekBar seekBar, int progress, bool fromUser)
        {
